...
app.controller('PerformanceDataController', ['$scope', 'backendHubProxy',
    function ($scope, backendHubProxy) {
        ...
        var performanceDataHub = backendHubProxy(backendHubProxy.defaultServer, 'chathub');
        ...
        performanceDataHub.on('showOK', function (data) {
            console.log("event showOK defined in controller");
            console.log(data);
        });

        performanceDataHub.invoke('showOK', function (data) {
            console.log("callback showOK defined in controller");
            console.log(data);

            $('#theSuccess2').html(message);
            $('#theSuccess2').show();
        });
